  ...
  return (
    <QueryClientProvider client={queryClient}>
      <AuthProvider>
        <TooltipProvider>
          <Helmet>
            <title>FotoDS | Dawid Siedlec - Interior Photography</title>
            <meta name="description" content="Professional interior and architectural photography by Dawid Siedlec." />
          </Helmet>
          <Toaster />
          <Router />
        </TooltipProvider>
