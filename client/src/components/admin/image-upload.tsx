  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Add new photos to your portfolio</CardDescription>
      </CardHeader>
      <CardContent>
        <Tabs 
          defaultValue="url" 
            ...
            <div className="space-y-6 mt-4">
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div className="space-y-3">
                  <Label htmlFor="mainImage">Full Size Image *</Label>
                  ...
                  {mainImagePreview ? (
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-500">Click to upload full size image</p>
                ...
                <div className="space-y-3">
                  <Label htmlFor="thumbnailImage">Thumbnail Image <span className="text-gray-400 text-xs">(Optional)</span></Label>
                  ...
                  {thumbnailPreview ? (
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-400 mt-1">If not provided, full size image will be used</p>
                    </div>
                  )}
          ...
          <Button type="submit" disabled={isPending || uploading} className="w-full">
            {isPending || uploading ? (
              <>
                ...
                {uploading ? "Uploading files..." : "Saving photo..."}
              </>
            ) : (
              "Add Photo"
            )}
