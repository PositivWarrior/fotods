...
export default function AdminPhotos() {
			...
			toast({
				...
				description:
					selectedCategory === 'all'
						...
						: `Photo order in ${getCategoryName(
								parseInt(selectedCategory),
						  )} has been saved`,
			});
		},
	...
	const getCategoryName = (categoryId: number | null | undefined) => {
		if (categoryId === null || categoryId === undefined || !categories)
			...
			<div className="flex justify-between items-center mb-6">
				<div>
					...
					<p className="text-muted-foreground">
						Add, edit, and delete photos in your portfolio. Drag
						photos to reorder them within a category.
					</p>
															...
															>
																...
																<TableCell>
																	<Button
																		...
																		title={
																			photo.featured
																				? 'Unmark as featured on homepage'
			...
			<Dialog open={showAddPhoto} onOpenChange={setShowAddPhoto}>
				<DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto pb-6">
					<DialogHeader>
						...
						<DialogDescription>
							Upload a new photo to your portfolio. Fill in all
							the details below.
						</DialogDescription>
					</DialogHeader>
				...
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							...
							{photoToDelete?.title}"? This action cannot be
							undone.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
