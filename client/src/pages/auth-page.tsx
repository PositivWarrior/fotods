...
export default function AuthPage() {
	...
	return (
		<>
			<Helmet>
				<title>Logg Inn | FotoDS Admin</title>
				<meta
					name="description"
					content="Logg inn på adminpanelet for FotoDS for å administrere portefølje, kategorier og annet innhold."
				/>
			</Helmet>
				...
				<div className="flex items-center justify-center w-full lg:w-1/2 p-8">
					<div className="w-full max-w-md">
						<div className="mb-8 text-center">
							<h1 className="text-3xl font-poppins font-semibold mb-2">
								FotoDS
							</h1>
							<p className="text-secondary">
								Photography by Dawid Siedlec
							</p>
						</div>
					...
					<div className="absolute inset-0 flex items-center justify-center p-12">
						<div className="max-w-lg text-white">
							...
							<p className="text-white/80 mb-6">
								...
								Add new photos, update categories, and handle
								customer inquiries all from one place.
							</p>
